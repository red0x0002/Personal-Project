...
bool    ImGui_ImplWin32_Init(void* hwnd)
{
    ...
    io.BackendPlatformName = c_xor("imgui_impl_win32");
    ...
    {
        c_xor("xinput1_4.dll"),   // Windows 8+
        c_xor("xinput1_3.dll"),   // DirectX SDK
        c_xor("xinput9_1_0.dll"), // Windows Vista, Windows 7
        c_xor("xinput1_2.dll"),   // DirectX SDK
        c_xor("xinput1_1.dll")    // DirectX SDK
    };
    for (int n = 0; n < IM_ARRAYSIZE(xinput_dll_names); n++)
        if (HMODULE dll = ::LoadLibraryA(xinput_dll_names[n]))
        {
            bd->XInputDLL = dll;
            bd->XInputGetCapabilities = (PFN_XInputGetCapabilities)::GetProcAddress(dll, c_xor("XInputGetCapabilities"));
            bd->XInputGetState = (PFN_XInputGetState)::GetProcAddress(dll, c_xor("XInputGetState"));
            break;
        }

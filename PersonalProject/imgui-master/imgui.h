...
#ifndef IM_ASSERT
#include <assert.h>
#define IM_ASSERT(_EXPR)            ((void)0)//assert(_EXPR)                               // You can override the default assert handler by editing imconfig.h
#endif
...
namespace ImGui
{
	...
	IMGUI_API bool          CheckboxBVM(const char* label, bool* v);
